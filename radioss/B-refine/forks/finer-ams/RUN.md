...
- **not reached** in this run (see blockers / last frame below).
...
- Belytschko N=1, 71232 quads. `/DT/NODA/STOP 0.9 1e-6` hang guard (not NODA/CST). /AMS on (Kareem fork).
