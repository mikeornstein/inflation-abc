...
def write_starter(mesh: dict, out: Path) -> dict:
    ...
    w(header_bar())
    w("/DEF_SHELL\n")
    w("#    Ishell    Ismstr    Ithick     Iplas              Ioffset             Ish3n   I_drill\n")
    w(i10(24) + i10(0) + i10(1) + i10(0) + i10(0) + i10(2) + i10(0) + i10(2) + i10(1) + "\n")
    ...
    w("#    Ishell    Ismstr     Ish3n    Idrill    Ipinch           P_thickfail\n")
    w(i10(24) + i10(10) + i10(2) + i10(1) + i10(0) + i10(0) + r20(0.0) + "\n")
    w("#                h_m                  h_f                  h_r                  d_m                  d_n\n")
    w(r20(0.0) + r20(0.0) + r20(0.0) + r20(0.05) + r20(0.0) + "\n")
    w("#         N                 Thick              Ashear              Ithick     Iplas\n")
    w(i10(1) + i10(0) + r20(H0) + r20(0.0) + i10(0) + i10(1) + i10(0) + "\n")
    ...
    w(i10(SURF_ID) + i10(0) + i10(5) + i10(0) + i10(1000) + i10(1) + i10(2) + i10(1000) + i10(0) + "\n")
    w("#          Fscalegap               Gapmax\n")
    w(r20(1.0) + r20(0.0) + "\n")
    ...
    w(i10(0) + i10(6) + r20(0.05) + r20(1.0) + r20(0.20) + "\n")
    w("#     Ifric    Ifiltr                Xfreq     Iform   sens_ID   fric_ID\n")
    w(i10(0) + i10(0) + r20(0.0) + i10(1) + i10(0) + i10(0) + "\n")
